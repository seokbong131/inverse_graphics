...
int main(int argc, char** argv) {
    filesystem::path input_before_path = image_io::join_path(
        INPUT_FOLDER, INPUT_FILE_BEFORE, FILE_EXTENSION);
    filesystem::path input_after_path = image_io::join_path(
        INPUT_FOLDER, INPUT_FILE_AFTER, FILE_EXTENSION);
